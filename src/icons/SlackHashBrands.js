...
function SvgSlackHashBrands(props) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
      data-icon="slack-hash"
      className="slack-hash-brands_svg__svg-inline--fa slack-hash-brands_svg__fa-slack-hash slack-hash-brands_svg__fa-w-14"
      viewBox="0 0 448 512"
      width="1em"
      height="1em"
      {...props}
...
export default SvgSlackHashBrands;
